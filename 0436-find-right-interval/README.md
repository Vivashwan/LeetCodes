<h2><a href="https://leetcode.com/problems/find-right-interval/?envType=problem-list-v2&envId=9ixr4vaj">436. Find Right Interval</a></h2><h3>Medium</h3><hr><p>You are given an array of <code>intervals</code>, where <code>intervals[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> and each <code>start<sub>i</sub></code> is <strong>unique</strong>.</p>
