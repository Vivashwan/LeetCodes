<h2><a href="https://leetcode.com/problems/flip-equivalent-binary-trees/?envType=problem-list-v2&envId=e5xnbz4r">951. Flip Equivalent Binary Trees</a></h2><h3>Medium</h3><hr><p>For a binary tree <strong>T</strong>, we can define a <strong>flip operation</strong> as follows: choose any node, and swap the left and right child subtrees.</p>
