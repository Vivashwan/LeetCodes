<h2><a href="https://leetcode.com/problems/score-after-flipping-matrix/?envType=problem-list-v2&envId=50f6p33i">861. Score After Flipping Matrix</a></h2><h3>Medium</h3><hr><p>You are given an <code>m x n</code> binary matrix <code>grid</code>.</p>
