...
class Solution {
private:
    void dfs(vector<vector<int>>& land, vector<vector<bool>>& vis, int r, int c, vector<int>& temp, int row, int col) {
        ...
        for (int i = 0; i < 4; i++) 
        {
            ...
            {
                dfs(land, vis, currRow, currCol, temp, row, col);
            }
        }
    }
public:
